...
import { AdminIdentity, AdminSummary, RequestStatus } from '../../types';
...
function ModuleView({ module, summary }: { module: ModuleId; summary: AdminSummary }) {
