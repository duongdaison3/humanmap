  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 pb-safe pointer-events-none">
      <div className="max-w-md mx-auto px-3 sm:px-4 pb-3 pointer-events-auto">
        <div className="clay-navbar rounded-lg px-2 sm:px-3 h-[4.25rem] flex items-center justify-between relative">
              ...
              return (
                <React.Fragment key="quick_need">
                  <button
                    ...
                    className="clay-btn-primary flex flex-col items-center justify-center -mt-5 p-3.5 transition-transform active:scale-95 cursor-pointer group"
                  ...
                  >
                      <div className={`p-1 rounded-md transition-colors ${isActive ? 'clay-pill-blue' : ''}`}>
